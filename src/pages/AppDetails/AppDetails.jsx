    ...
    return (
        <div className="sm:px-6 lg:px-40 py-10 bg-gray-100">
            ...
            <div className="flex flex-col md:flex-row gap-10 mb-10">
                <div>
                    <img src={image} alt={title} className="rounded-lg shadow-md w-[300px] h-[300px] bg-white p-15" />
                </div>
                <div>
                    ...
                    <div className="flex flex-wrap justify-center gap-6 mb-4 py-10">
                        <div className="flex flex-col justify-center items-center gap-2">
                            <BsDownload className='text-green-500 font-bold' />
                            <p>Downloads</p>
                            <h1 className="text-2xl font-bold">{downloads}</h1>
                        </div>
                        <div className="flex flex-col justify-center items-center gap-2">
                            <IoIosStar className='text-orange-500 font-bold' />
                            <p>Rating</p>
                            <h1 className="text-2xl font-bold">{ratingAvg}</h1>
                        </div>
                        <div className="flex flex-col justify-center items-center gap-2">
                            <MdRateReview className='text-purple-600' />
                            <p>Reviews</p>
                            <h1 className="text-2xl font-bold">{reviews}</h1>
                        </div>
                    </div>
                    <button onClick={handleInstall} className="btn bg-green-500 text-white font-semibold px-4 py-2 rounded-md">
                        Install Now (200 MB)
                    </button>
                </div>
            </div>
                        ...
                        <div key={star} className="flex items-center gap-4">
                            ...
                            <div className="bg-orange-300 h-4 rounded-md w-full">
                                <div
                                    ...
                                    style={{ width: `${(ratingBreakdown?.[star] || 0) / totalRatings * 100}%` }}
                                ></div>
                            </div>
