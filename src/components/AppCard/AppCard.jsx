...
const AppCard = ({ appData }) => {
    const { image, title, price, downloads, ratingAvg } = appData;
    return (
        <div>
            <div className="card bg-base-100 shadow-md hover:shadow-lg hover:scale-105 transition-all duration-300">
